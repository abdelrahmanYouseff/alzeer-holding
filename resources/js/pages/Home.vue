      ...
      <div class="container">
        <div class="header-content">
          ...
          <div class="logo-section">
            <img src="/Screenshot_1447-03-29_at_10.51.05_AM-removebg-preview.png" alt="Alzeer Group Holding" class="logo-image" />
        </div>
          ...
          <div class="footer-contact-section">
            ...
            <div class="footer-contact-list">
              <div class="footer-contact-item">
                ...
                <span class="contact-text">{{ currentLanguage === 'AR' ? 'شارع الملك عبدالعزيز، حي المروج ، الرياض' : 'King Abdulaziz Rd, Al Muruj, Riyadh 12465' }}</span>
              </div>
              <div class="footer-contact-item">
                <svg class="contact-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                </svg>
                <span class="contact-text" dir="ltr">+96655 512 6435</span>
              </div>
              <div class="footer-contact-item">
                <svg class="contact-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
.bg-circle-1 {
  ...
  width: 16rem;
  height: 16rem;
  background: rgba(217, 187, 89, 0.1);
...
.cta-box {
  background: linear-gradient(to right, rgba(217, 187, 89, 0.1), rgba(245, 158, 11, 0.1));
