...
const messages = {
  EN: {
    ...
    'contact.addressText': 'Dubai, United Arab Emirates',
    ...
    'contact.mapDescription': 'Visit our office in Dubai for a face-to-face meeting.',
  ...
  AR: {
    ...
    'contact.mapDescription': 'قم بزيارة مكتبنا في دبي لمقابلة وجهاً لوجه.',
